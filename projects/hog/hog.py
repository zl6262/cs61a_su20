...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    # tens dights and ones dights
    td, od = score//10, score%10
    return td+10-od
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    abs_diff = abs(player_score % 10 - opponent_score % 10)
    if abs_diff == (opponent_score//10)%10:
        return True
    return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 <goal and score1< goal:
        if who == 0:
            ...
            get_score = take_turn(num_dice, score1, dice)
            score0 += get_score
            if feral_hogs and abs(num_dice-last0)==2:
                score0 += 3
            last0 = get_score
            ...
            get_score = take_turn(num_dice, score0, dice)
            score1 += get_score
            if feral_hogs and abs(num_dice-last1)==2:
                score1 += 3
            last1 = get_score
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if gain > current_high:
            print(gain, "point(s)! That's the biggest gain yet for Player", who)
            current_high = gain
        return announce_highest(who, current_score, current_high)
    return say
...
def make_averaged(original_function, trials_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    # END PROBLEM 8
    res, left_count = 0, trials_count
    def child_func(*args):
        nonlocal res, left_count
        while left_count:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    i_max, score_max = 1, 0
    for i in range(1,11):
        score_i = make_averaged(roll_dice, trials_count)(i, dice)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score > opponent_score + 10:
        ...
        return swap_strategy(score, opponent_score, 8, 3)
